...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "scan_type",
            sa.Enum("GOOGLE_CLOUD_IAM", "GOOGLE_WORKSPACE", "COMPREHENSIVE", name="scantype"),
            nullable=False,
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "MEDIUM", "HIGH", "CRITICAL", name="scanpriority"),
            nullable=False,
        ...
        sa.Column(
            "progress_percentage", sa.Float(), nullable=False, comment="Progress percentage (0-100)"
        ),
        sa.Column(
            "current_step",
            sa.String(length=200),
        ...
        sa.Column(
            "total_steps", sa.Integer(), nullable=True, comment="Total number of steps in the scan"
        ),
        sa.Column(
            "completed_steps", sa.Integer(), nullable=True, comment="Number of completed steps"
        ),
        sa.Column(
            "total_policies_scanned",
            sa.Integer(),
            nullable=True,
        ...
        sa.Column(
            "high_findings", sa.Integer(), nullable=True, comment="Number of high severity findings"
        ),
        sa.Column(
            "medium_findings",
            sa.Integer(),
        ...
        sa.Column(
            "low_findings", sa.Integer(), nullable=True, comment="Number of low severity findings"
        ),
        ...
        sa.Column(
            "error_message", sa.Text(), nullable=True, comment="Error message if scan failed"
        ),
        sa.Column(
            "error_details",
            sa.JSON(),
        ...
        sa.Column(
            "max_retries", sa.Integer(), nullable=False, comment="Maximum number of retry attempts"
        ),
        sa.Column(
            "tags", sa.JSON(), nullable=True, comment="Tags for categorizing and filtering scans"
        ),
        sa.Column(
            "scan_metadata", sa.JSON(), nullable=True, comment="Additional metadata in JSON format"
        ),
        sa.Column(
            "external_scan_id",
            sa.String(length=200),
        ...
        sa.Column(
            "created_by", sa.UUID(), nullable=False, comment="ID of user who initiated the scan"
        ),
        sa.Column(
            "is_recurring", sa.Boolean(), nullable=False, comment="Whether this is a recurring scan"
        ),
        sa.Column(
            "is_baseline",
            sa.Boolean(),
        ...
        sa.Column(
            "version", sa.Integer(), nullable=False, comment="Version number for optimistic locking"
        ),
    ...
    op.create_index(
        op.f("ix_scan_target_resource_id"), "scan", ["target_resource_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "username", sa.String(length=100), nullable=False, comment="Unique username for login"
        ),
        sa.Column(
            "password_hash",
            sa.String(length=255),
        ...
        sa.Column(
            "auth_provider",
            sa.Enum("LOCAL", "MICROSOFT", "GOOGLE", "SAML", name="authenticationprovider"),
            nullable=False,
        ...
        sa.Column(
            "avatar_url", sa.String(length=500), nullable=True, comment="URL to user's avatar image"
        ),
        sa.Column(
            "phone_number", sa.String(length=20), nullable=True, comment="User's phone number"
        ),
        sa.Column(
            "department",
            sa.String(length=100),
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "ANALYST", "VIEWER", "AUDITOR", name="userrole"),
            nullable=False,
            comment="User's role for access control",
        ),
        sa.Column(
            "permissions", sa.Text(), nullable=True, comment="Additional permissions in JSON format"
        ),
        sa.Column(
            "is_superuser",
            sa.Boolean(),
        ...
        sa.Column(
            "is_verified", sa.Boolean(), nullable=False, comment="Whether user's email is verified"
        ),
        sa.Column(
        ...
        sa.Column(
            "last_login_ip", sa.String(length=45), nullable=True, comment="IP address of last login"
        ),
        sa.Column(
        ...
        sa.Column(
            "created_by", sa.UUID(), nullable=True, comment="ID of user who created this account"
        ),
        sa.Column("id", sa.UUID(), nullable=False, comment="Unique identifier for the record"),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        "policy",
        sa.Column(
            "name", sa.String(length=300), nullable=False, comment="Policy name or identifier"
        ),
        sa.Column(
            "display_name",
        ...
        sa.Column(
            "effect",
            sa.Enum("ALLOW", "DENY", "CONDITIONAL", name="policyeffect"),
            nullable=True,
            comment="Effect of the policy (allow/deny)",
        ),
        sa.Column(
            "policy_content", sa.JSON(), nullable=True, comment="Raw policy content in JSON format"
        ),
        sa.Column("policy_document", sa.Text(), nullable=True, comment="Policy document as text"),
        sa.Column(
            "conditions", sa.JSON(), nullable=True, comment="Policy conditions in JSON format"
        ),
        sa.Column(
            "resource_id",
            sa.String(length=500),
        ...
        sa.Column(
            "compliance_score", sa.Float(), nullable=False, comment="Compliance score (0-100)"
        ),
        sa.Column("category", sa.String(length=100), nullable=True, comment="Policy category"),
        sa.Column(
            "subcategory", sa.String(length=100), nullable=True, comment="Policy subcategory"
        ),
        ...
        sa.Column(
            "is_enforced", sa.Boolean(), nullable=False, comment="Whether the policy is enforced"
        ),
        sa.Column(
            "is_system_managed",
            sa.Boolean(),
        ...
        sa.Column(
            "created_by", sa.String(length=200), nullable=True, comment="Creator of the policy"
        ),
        sa.Column(
            "approved_by", sa.String(length=200), nullable=True, comment="Approver of the policy"
        ),
        sa.Column(
            "approved_at", sa.DateTime(timezone=True), nullable=True, comment="Approval timestamp"
        ),
        sa.Column(
            "review_required",
            sa.Boolean(),
    ...
    op.create_index(
        op.f("ix_policy_compliance_score"), "policy", ["compliance_score"], unique=False
    )
    op.create_index(
        op.f("ix_policy_compliance_status"), "policy", ["compliance_status"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_policy_last_analyzed_at"), "policy", ["last_analyzed_at"], unique=False
    )
    op.create_index(op.f("ix_policy_name"), "policy", ["name"], unique=False)
    op.create_index(
        op.f("ix_policy_next_review_date"), "policy", ["next_review_date"], unique=False
    )
    op.create_index(
        op.f("ix_policy_parent_policy_id"), "policy", ["parent_policy_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "category", sa.String(length=100), nullable=True, comment="Recommendation category"
        ),
        sa.Column(
            "subcategory",
            sa.String(length=100),
        ...
        sa.Column(
            "tags", sa.JSON(), nullable=True, comment="Tags for categorization and filtering"
        ),
        sa.Column(
        ...
        sa.Column(
            "impact_assessment", sa.Text(), nullable=True, comment="Assessment of potential impact"
        ),
        sa.Column(
            "risk_reduction",
            sa.Float(),
        ...
        sa.Column(
            "business_impact", sa.Text(), nullable=True, comment="Business impact description"
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_recommendation_assigned_to"), "recommendation", ["assigned_to"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_category"), "recommendation", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_completed_at"), "recommendation", ["completed_at"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_created_at"), "recommendation", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_recommendation_cve_id"), "recommendation", ["cve_id"], unique=False)
    op.create_index(
        op.f("ix_recommendation_deleted_at"), "recommendation", ["deleted_at"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_due_date"), "recommendation", ["due_date"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_framework"), "recommendation", ["framework"], unique=False
    )
    op.create_index(op.f("ix_recommendation_id"), "recommendation", ["id"], unique=False)
    op.create_index(
        op.f("ix_recommendation_implementation_status"),
        "recommendation",
        ["implementation_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_recommendation_policy_id"), "recommendation", ["policy_id"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_priority"), "recommendation", ["priority"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_recommendation_type"),
        "recommendation",
        ["recommendation_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recommendation_severity"), "recommendation", ["severity"], unique=False
    )
    op.create_index(
        op.f("ix_recommendation_subcategory"), "recommendation", ["subcategory"], unique=False
    )
    op.create_index(op.f("ix_recommendation_title"), "recommendation", ["title"], unique=False)
    op.create_index(
        op.f("ix_recommendation_updated_at"), "recommendation", ["updated_at"], unique=False
    )
