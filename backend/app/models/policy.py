...
class Policy(Base):
    ...
    name: Mapped[str] = mapped_column(
        String(300), nullable=False, index=True, comment="Policy name or identifier"
    )

    display_name: Mapped[Optional[str]] = mapped_column(
        String(300), nullable=True, comment="Human-readable display name"
    )
    ...
    policy_type: Mapped[PolicyType] = mapped_column(
        SQLEnum(PolicyType), nullable=False, index=True, comment="Type of policy"
    )
    ...
    policy_content: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON, nullable=True, comment="Raw policy content in JSON format"
    )

    policy_document: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, comment="Policy document as text"
    )

    conditions: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(
        JSON, nullable=True, comment="Policy conditions in JSON format"
    )

    # Resource and scope information
    resource_id: Mapped[Optional[str]] = mapped_column(
        String(500), nullable=True, index=True, comment="Resource identifier this policy applies to"
    )

    resource_type: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, index=True, comment="Type of resource this policy applies to"
    )

    scope: Mapped[Optional[str]] = mapped_column(
        String(500), nullable=True, comment="Scope of the policy (subscription, project, etc.)"
    )
    ...
    principal_type: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True, comment="Type of principal (user, group, service account)"
    )
    ...
    risk_score: Mapped[float] = mapped_column(
        Float, default=0.0, nullable=False, index=True, comment="Risk score (0-100)"
    )
    ...
    compliance_score: Mapped[float] = mapped_column(
        Float, default=0.0, nullable=False, index=True, comment="Compliance score (0-100)"
    )

    # Classification and categorization
    category: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, index=True, comment="Policy category"
    )

    subcategory: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, index=True, comment="Policy subcategory"
    )

    tags: Mapped[Optional[Dict[str, str]]] = mapped_column(
        JSON, nullable=True, comment="Policy tags for categorization"
    )

    # Access and permissions
    permissions: Mapped[Optional[List[str]]] = mapped_column(
        JSON, nullable=True, comment="List of permissions granted by this policy"
    )

    actions: Mapped[Optional[List[str]]] = mapped_column(
        JSON, nullable=True, comment="List of actions allowed/denied by this policy"
    )

    resources: Mapped[Optional[List[str]]] = mapped_column(
        JSON, nullable=True, comment="List of resources affected by this policy"
    )
    ...
    is_enforced: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False, comment="Whether the policy is enforced"
    )

    is_system_managed: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False, comment="Whether the policy is system-managed"
    )
    ...
    external_version: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, comment="External policy version"
    )
    ...
    analysis_version: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True, comment="Version of analysis performed"
    )

    findings_count: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="Number of findings associated with this policy"
    )

    recommendations_count: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="Number of recommendations for this policy"
    )

    # Audit and governance
    created_by: Mapped[Optional[str]] = mapped_column(
        String(200), nullable=True, comment="Creator of the policy"
    )

    approved_by: Mapped[Optional[str]] = mapped_column(
        String(200), nullable=True, comment="Approver of the policy"
    )
    ...
    review_required: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False, comment="Whether policy requires review"
    )

    next_review_date: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True, index=True, comment="Next scheduled review date"
    )
    ...
    def requires_attention(self) -> bool:
        ...
        return (
            self.is_high_risk
            or not self.is_compliant
            or self.review_required
            or (self.next_review_date and self.next_review_date <= datetime.utcnow())
        )
