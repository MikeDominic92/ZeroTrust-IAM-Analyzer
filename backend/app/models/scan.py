...
class Scan(Base):
    ...
    name: Mapped[str] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Human-readable name for the scan"
    )
    
    description: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Detailed description of the scan purpose"
    )
    ...
    scan_type: Mapped[ScanType] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Type of scan being performed"
    )
    ...
    config: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Scan configuration parameters in JSON format"
    )
    
    target_scope: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Target scope description (subscription, project, etc.)"
    )
    ...
    credentials_used: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        comment="Type of credentials used for the scan"
    )
    ...
    started_at: Mapped[Optional[datetime]] = mapped_column(
        ...
        nullable=True,
        index=True,
        comment="Actual start time of the scan"
    )
    ...
    completed_at: Mapped[Optional[datetime]] = mapped_column(
        ...
        nullable=True,
        index=True,
        comment="Completion time of the scan"
    )
    
    duration_seconds: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Total duration of the scan in seconds"
    )
    ...
    timeout_seconds: Mapped[Optional[int]] = mapped_column(
        ...
        nullable=True,
        default=3600,
        comment="Maximum allowed duration in seconds"
    )
    ...
    current_step: Mapped[Optional[str]] = mapped_column(
        String(200),
        nullable=True,
        comment="Current step being processed"
    )
    
    total_steps: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Total number of steps in the scan"
    )
    ...
    total_policies_scanned: Mapped[Optional[int]] = mapped_column(
        ...
        nullable=True,
        default=0,
        comment="Total number of policies scanned"
    )
    ...
    total_resources_analyzed: Mapped[Optional[int]] = mapped_column(
        ...
        nullable=True,
        default=0,
        comment="Total number of resources analyzed"
    )
    ...
    total_findings: Mapped[Optional[int]] = mapped_column(
        ...
        nullable=True,
        default=0,
        comment="Total number of findings identified"
    )
    ...
    error_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Detailed error information in JSON format"
    )
    ...
    tags: Mapped[Optional[Dict[str, str]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Tags for categorizing and filtering scans"
    )
    ...
    created_by: Mapped[uuid.UUID] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="ID of user who initiated the scan"
    )
    ...
    is_recurring: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether this is a recurring scan"
    )
    ...
    is_baseline: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether this scan serves as a baseline"
    )
    ...
    notify_on_completion: Mapped[bool] = mapped_column(
        ...
        default=True,
        nullable=False,
        comment="Whether to notify on scan completion"
    )
    ...
    def can_retry(self) -> bool:
        ...
        return (
            self.status in [ScanStatus.FAILED, ScanStatus.TIMEOUT] and
