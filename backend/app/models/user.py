...
class User(Base):
    ...
    password_hash: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="Hashed password (null for external auth providers)"
    )
    ...
    display_name: Mapped[Optional[str]] = mapped_column(
        String(200),
        nullable=True,
        comment="Display name for UI purposes"
    )
    ...
    department: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        comment="User's department or organization unit"
    )
    
    job_title: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        comment="User's job title"
    )
    ...
    permissions: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Additional permissions in JSON format"
    )
    ...
    password_expires_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
        comment="Timestamp when password expires"
    )
    ...
    session_token: Mapped[Optional[str]] = mapped_column(
        ...
        nullable=True,
        index=True,
        comment="Current active session token"
    )
    
    refresh_token: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="Refresh token for session management"
    )
    
    token_expires_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
        comment="Timestamp when current token expires"
    )
