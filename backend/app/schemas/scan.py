...
class ScanCreate(ScanBase):
    ...
    timeout_seconds: Optional[int] = Field(default=3600, ge=60, le=86400, description="Timeout in seconds")
...
class MicrosoftEntraConfig(BaseSchema):
    ...
    exclude_system_managed: bool = Field(default=True, description="Exclude system-managed policies")
